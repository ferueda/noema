...
- Deterministic and semantic extraction remain independent of agent output
  ...
  claims implicitly.
- The pre-V1 walking-skeleton database is disposable scaffold state, not a
  supported product contract. Milestone 3 defines a clean V1 schema and does
  not decode, backfill, import, or dual-write the retired shape. Pre-V1 local
